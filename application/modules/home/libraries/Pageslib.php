...
class Pageslib{
	...
	public function getArticlesByCategoryId($categoryId) {
        $post = $this->CI->home_model->getArticlesByCategoryId($categoryId);
        return $post;
    }

    public function generateArticleDescription($slug){
    	return $this->CI->home_model->getArticleMetaDesc($slug);
    }
}