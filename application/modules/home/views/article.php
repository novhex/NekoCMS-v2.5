...
<div class="container" style="margin-top: 70px;">
	<div class="row">
		<div class="col-md-12">
			<h1 style="text-align: center; margin-top: 50px; font-size: 20px;" >RELATED POST</h1>
<?php $relatedpost = $this->pageslib->getArticlesByCategoryId($index['parent_category']) ?>
	<?php if ($relatedpost): ?>
		<?php foreach($relatedpost as $posts): ?>
			
					<div class="col-md-12" style="text-align:center;">
					<a href="<?php echo base_url('article').'/'.$posts['slug']; ?>"><?php echo $posts['title']; ?></a>
