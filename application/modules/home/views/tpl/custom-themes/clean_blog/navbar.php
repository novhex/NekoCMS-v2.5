    ...
    <nav class="navbar navbar-inverse navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="<?php echo base_url();?>">Kel Novi</a>
            </div>
              ...
              <?php foreach($pages as $page){?>
                ...
                <li class="dropdown">
                  ...
                  ?>
                    ...
                    <li><a  style="color:black;" href="<?php echo base_url('category').'/'.$c['category_slug'];?>"><?php echo $c['category_name'];?></a></li>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="site-heading">
                        <h1>Kel Novi</h1>
                        <hr class="small">
                        <span class="subheading">&middot; Eat &middot; Sleep  &middot; Code &middot;</span>
                    </div>
                </div>
            </div>
        </div>
