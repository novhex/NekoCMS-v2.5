...
<!-- HTML METAS !-->
    ...
    <meta property="og:description" content="<?php echo strip_tags($site_desc);?>" />
    ...
    <!-- CSS STYLESHEETS -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/bootstrap.min-cosmo.css');?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('custom_css/user.css');?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('flatv2/lib/css/font-awesome.min.css');?>">

  

    <!-- PRIMARY JAVASCRIPT PLUGINS-->
