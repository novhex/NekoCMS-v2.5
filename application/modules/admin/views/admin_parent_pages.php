                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    <div class="title"><i class="fa fa-book"></i> Parent Pages</div>
                                </div>
                            ...
                            <a id="add_page" style="margin-bottom: 20px;" class="btn btn-primary btn-sm"><i class="fa fa-book"></i> Add Page</a>
