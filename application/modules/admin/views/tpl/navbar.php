                ...
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <ol class="breadcrumb navbar-breadcrumb">
                            <li class="active"><i class="fa fa-dashboard"></i> NekoCMS-v 2.x  Dashboard</li>
                        </ol>
                ...
                <nav class="navbar navbar-default" role="navigation">
                    <div class="side-menu-container">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="panel panel-default dropdown">
                                <a data-toggle="collapse" href="#dropdown-subscribers">
                                    <span class="icon fa fa-newspaper-o"></span><span class="title">Newsletter</span>
                                </a>
                                <!-- Dropdown level 1 -->
                                <div id="dropdown-subscribers" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                                   <li>
                                            <a href="<?php  echo base_url('admin/newsletter/');?>">Send NewsLetter</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo base_url('admin/newsletter-subscribers/'); ?>">Subscribers</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
