...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <!-- JQUERY TAGIT !-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('flatv2/css/jquery.tagit.css');?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('flatv2/css/tagit.ui-zendesk.css');?>">
