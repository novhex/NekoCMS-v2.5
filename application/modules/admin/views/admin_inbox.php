                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    <div class="title"><i class="fa fa-envelope"></i> Inbox</div>
                                </div>
							...
							<div class="table-responsive">
								...
								<?php
									foreach($message_list as $messageLists):
										...
										echo "<td>".date('F j, Y h:i:s a',strtotime($messageLists['date_recieved']))."</td>";
										...
										echo "<td><a   data-id='$messageLists[msgID]' title='' class='deletemsg btn btn-primary' href='#'><span class='glyphicon glyphicon-trash'></span> Delete</a>  <a class='btn btn-primary' id='viewMsg' href='".base_url()."admin/showmessage/$messageLists[msgID]'><span class='glyphicon glyphicon-zoom-in'></span> View</a></td>";
										echo "</tr>";
									 endforeach ?>
