                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    <div class="title"><i class="fa fa-list"></i> Page Categories</div>
                                </div>
                                <div class="pull-right card-action">
                                </div>
                            </div>
                            <div class="card-body">
                            <a href="<?php echo base_url('admin/add-page-category');?>" id="add_category" style="margin-bottom: 20px;" class="btn btn-primary btn-sm"><i class="fa fa-plus-square"></i>  Add Page Category</a>
