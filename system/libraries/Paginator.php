...
class CI_Paginator{
	...
	*/
	 ...
	 */
	public function set_config($perPage,$instance){
	...
	*/
	private function set_instance(){
		...
		$this->_page = ($this->_page == 0 || $this->_page <= -1 ? 1 : $this->_page);
	}
	/**
	 * set_total
	 *
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$prev"."$ext'>&laquo; Previous</a></li>";
		else
		...
		if ($counter == $this->_page)
		    $pagination.= "<li><span class='current active'>$counter</span></li>";
		else
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$next"."$ext'>Next &raquo;</a></li>";
		else
